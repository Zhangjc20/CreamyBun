# Generated by Django 3.2.14 on 2022-11-20 03:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('material_description', models.CharField(default='no description', max_length=500)),
            ],
        ),
        migrations.CreateModel(
            name='Problem',
            fields=[
                ...
                ('material_path', models.ManyToManyField(to='CreamyBunApp.MaterialDict')),
            ],
        ),
        migrations.CreateModel(
            name='Question',
