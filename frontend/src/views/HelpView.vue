    ...
    <el-container class="container">
      ...
      <el-main class="main-style">
        <div class="feedback-box">
          <div class="feedback-title-outer"><span class="feedback-title">反馈问题</span></div>
          <div class="feedback-type">
            ...
            <el-row class="el-row">
              <el-form-item style="width:100%">
                <el-select v-model="companyType" style="width:100%">
                  ...
                  <el-option v-for="item in companyTypes" :key="item.id" :label="item.value" :value="item.value">
                  </el-option>
                </el-select>
              </el-form-item>
            </el-row>
            ...
            <el-row>
              <el-input type="textarea" :rows="6" placeholder="请说明问题描述与建议，我们将为您不断改进~" v-model="textarea"></el-input>
              <el-upload
            ...
            <el-row class="el-row">
              <el-input type="textarea" :rows="1" placeholder="请输出邮箱~" v-model="email"></el-input>
            </el-row>
          </div>
          ...
          <div class="feedback-title-outer">
            <pre class="contact-info">电话：13812341234      邮箱：baidu@123.com</pre>
          </div>
        </div>
      </el-main>
    </el-container>
