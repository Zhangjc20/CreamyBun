<template>
  <el-container>
    <div class="background-box">
      <div class="main-box">
        <div class="logo"></div>
        <el-form class="login-form" ref="ruleFormRef" status-icon>
          ...
          <el-form-item required>
            <div class="link-box">
              <el-link type="primary" class="logup-link" @click="clickLogup"
                >没有账号？立即注册</el-link
              >
              <el-link
                type="primary"
          ...
          <el-form-item>
            <el-button class="login-button" @click="clickLogin">登录</el-button>
          </el-form-item>
        </el-form>
      </div>
    </div>
