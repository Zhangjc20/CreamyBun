<template>
  <el-dialog title="发送邮件" v-model="dialogVisible" center width=580px>
   <div style="display: flex;flex-direction: column;align-items: center;justify-content: center;">
     <el-form :inline="true">
       <el-form-item>
         <el-input style="width: 380px" v-model="emailContent" placeholder="请输入邮件内容"  type="textarea" :autosize="{ minRows: 5, maxRows: 5 }"></el-input>
       </el-form-item>
     </el-form>
     <p style="color: #f00;">提示: 点击发送邮件将发送到{{props.inform_email}}</p>
     <p style="color: #f00;"> </p>
     <div class="button-box">
       <el-row>
         <CustomButton title="发送"  normalColor="#fbe484" focusColor="#fbe487" hoverColor="#4E98AB" @click="sendTheEmail"/>
         <CustomButton title="取消" marginLeft="60px" normalColor="#fbe484" focusColor="#fbe487" hoverColor="#4E98AB" @click="CancelSendEmail"/>
       </el-row>
     </div>
   </div>
 </el-dialog>
 ...
 <div class="task-container" v-else>
   <div class="task-container-inner" style="border: 2px solid #e9e9e9;">
     <div style="float: left;">
       <el-image :src="image.src ? image.src : require('@/assets/images/avatar.jpeg')" style="width:220px;height:180px;"></el-image>
     </div>
     <div class="color-bg-box" style="float: right;">
       ...
       <div class="button-box">
         <el-row>
             <CustomButton title="删除反馈"  normalColor="#fbe484" focusColor="#fbe487" hoverColor="#4E98AB" @click="deleteFeedback"/>
             <CustomButton title="发送邮件" marginLeft="40px" normalColor="#fbe484" focusColor="#fbe487" hoverColor="#4E98AB" @click="sendEmail"/>
         </el-row>
       </div>
     </div>
   </div>
