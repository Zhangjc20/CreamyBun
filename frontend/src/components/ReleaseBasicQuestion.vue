  ...
  <el-main class="main-style">
    <el-row style="height: 50px">
      ...
      <CustomButton
        ...
        isRound="true"
        style="float: right; right: 120px; position: absolute"
    ...
    >
      <el-table-column prop="name" label="选项" width="100"> </el-table-column>
  ...
  methods: {
    ...
    checkContent() {
      if (
        ...
        (this.questionType == 0 || this.questionType == 1)
      ) {
        this.$message({
          message: "您尚未添加选项！",
          type: "warning",
